...
layout = [ 
            ...
            [sg.Text("Select your account:", visible=accounts_visible), sg.DropDown(accounts, key='-ACCOUNT-', default_value=default_account, visible=accounts_visible), sg.Button('Start')],
            [sg.Text("-------------------------------------------------------------------------------------------------------------------------------------------------------")],
